import type { Achievement } from "@shared/config/interfaces/interfaces";
import type { CandyColor } from "@shared/config/types/types";

export const DEV = import.meta.env.DEV;

export const GAME_FONT = "GameFont";
export const RENDER_BOUNDS = false;

export const GRID_SIZE = 8;
export const CANDY_COLORS: CandyColor[] = ['red', 'blue', 'green', 'yellow', 'purple', 'orange'];
export const JAR_MAX = 20;

export const STORAGE_KEY = 'fruit_crash_save_v7_ls'; 
export const ACHIEVEMENTS_KEY = 'fruit_crash_achievements_v5_ls';
